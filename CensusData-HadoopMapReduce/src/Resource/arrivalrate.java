...
Connection con;
    ...
    private XYDataset createDataset() {
      ...
      series1.add(0.0,5000);
        series1.add(ar.get(0), cost.get(0));
        series1.add(ar.get(1),cost.get(1));
        series1.add(ar.get(2), cost.get(2));
        series1.add(ar.get(3), cost.get(3));
        
        series1.add(ar.get(4),cost.get(4));
...
//        series2.add(85.0, 7);
    ...
    private JFreeChart createChart(final XYDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createXYLineChart(
            ...
            "Task Arrival Rate",                      // x axis label
...
//        plot.setRenderer(renderer);
    ...
    public static void main(final String[] args) {
        ...
        final arrivalrate demo = new arrivalrate("Comparison of number of task migrations when there are 7 VMs");
        demo.pack();
